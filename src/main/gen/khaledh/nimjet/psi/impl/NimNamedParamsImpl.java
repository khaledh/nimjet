...
public class NimNamedParamsImpl extends ASTWrapperPsiElement implements NimNamedParams {

  public NimNamedParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NimVisitor visitor) {
    visitor.visitNamedParams(this);
  }
