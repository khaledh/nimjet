...
public class NimBraceSuffixImpl extends ASTWrapperPsiElement implements NimBraceSuffix {

  public NimBraceSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NimVisitor visitor) {
    visitor.visitBraceSuffix(this);
  }
