...
public class NimParser implements PsiParser, LightPsiParser {
  ...
  static boolean parse_root_(IElementType t, PsiBuilder b, int l) {
    return nim_file(b, l + 1);
  }

  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(AMP_EXPR, AND_EXPR, ARROW_EXPR, ASSIGN_EXPR,
      BASIC_EXPR, BLOCK_EXPR, CASE_STMT, CMP_EXPR,
      DOLLAR_EXPR, EXPR, FOR_EXPR, IF_EXPR,
      MUL_EXPR, OR_EXPR, PLUS_EXPR, PRIMARY_EXPR,
      SIMPLE_EXPR, SLICE_EXPR, TRY_EXPR, WHEN_EXPR),
  };
  ...
  static boolean OP0(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "", OP_ARROW, OP_ARROW_LIKE)) return false;
    boolean r;
  ...
  static boolean OP6(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "", DOTDOT, OP_DOTLIKE)) return false;
    boolean r;
  ...
  static boolean OPR(PsiBuilder b, int l) {
  ...
  //                             )+
  //                           ACCENT
  public static boolean acc_quoted(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "acc_quoted")) return false;
    if (!nextTokenIs(b, ACCENT)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, ACC_QUOTED, null);
    r = consumeToken(b, ACCENT);
    p = r; // pin = 1
    r = r && report_error_(b, acc_quoted_1(b, l + 1));
  ...
  //                             | (operator|DOT|DOTDOT|EQUALS|LPAREN|RPAREN|LBRACKET|RBRACKET|LBRACE|RBRACE)+
  //                             )+
  private static boolean acc_quoted_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "acc_quoted_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = acc_quoted_1_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!acc_quoted_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "acc_quoted_1", c)) break;
    }
  ...
  // keyword | ident
  //                             | (operator|DOT|DOTDOT|EQUALS|LPAREN|RPAREN|LBRACKET|RBRACKET|LBRACE|RBRACE)+
  private static boolean acc_quoted_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "acc_quoted_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = keyword(b, l + 1);
    if (!r) r = ident(b, l + 1);
    if (!r) r = acc_quoted_1_0_2(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // (operator|DOT|DOTDOT|EQUALS|LPAREN|RPAREN|LBRACKET|RBRACKET|LBRACE|RBRACE)+
  private static boolean acc_quoted_1_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "acc_quoted_1_0_2")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = acc_quoted_1_0_2_0(b, l + 1);
    while (r) {
      int c = current_position_(b);
      if (!acc_quoted_1_0_2_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "acc_quoted_1_0_2", c)) break;
    }
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // operator|DOT|DOTDOT|EQUALS|LPAREN|RPAREN|LBRACKET|RBRACKET|LBRACE|RBRACE
  private static boolean acc_quoted_1_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "acc_quoted_1_0_2_0")) return false;
    boolean r;
    r = operator(b, l + 1);
  ...
  /* ********************************************************** */
  // BLOCK ident? colon_comment stmt_list
  ...
  //                         | AUTO | VARARGS
  static boolean built_in(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // TYPE | STATIC | ADDR
  static boolean built_in_magics(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // BIGGEST_FLOAT | BIGGEST_INT | BIGGEST_UINT
  ...
  static boolean c_type(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "c_type")) return false;
    boolean r;
    r = consumeToken(b, BIGGEST_FLOAT);
    if (!r) r = consumeToken(b, BIGGEST_INT);
    if (!r) r = consumeToken(b, BIGGEST_UINT);
    if (!r) r = consumeToken(b, CCHAR);
    if (!r) r = consumeToken(b, CDOUBLE);
    if (!r) r = consumeToken(b, CFLOAT);
    if (!r) r = consumeToken(b, CINT);
    if (!r) r = consumeToken(b, CLONG);
    if (!r) r = consumeToken(b, CLONG_DOUBLE);
    if (!r) r = consumeToken(b, CLONG_LONG);
    if (!r) r = consumeToken(b, CSCHAR);
    if (!r) r = consumeToken(b, CSHORT);
    if (!r) r = consumeToken(b, CSIZE_T);
    if (!r) r = consumeToken(b, CSTRING_ARRAY);
    if (!r) r = consumeToken(b, CUCHAR);
    if (!r) r = consumeToken(b, CUINT);
    if (!r) r = consumeToken(b, CULONG);
    if (!r) r = consumeToken(b, CULONG_LONG);
    if (!r) r = consumeToken(b, CUSHORT);
    return r;
  }
  ...
  public static boolean cast_expr(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<cast expr>", CAST, LPAREN)) return false;
    boolean r;
  ...
  public static boolean cmd_start(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmd_start")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, CMD_START, "<cmd start>");
    r = ident(b, l + 1);
  ...
  static boolean colon_body(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // COLON COMMENT?
  static boolean colon_comment(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // COMMA COMMENT?
  static boolean comma_optcomment(PsiBuilder b, int l) {
  ...
  public static boolean command_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, COMMAND_EXPR, "<command expr>");
  ...
  private static boolean command_param_first_1(PsiBuilder b, int l) {
    ...
    command_param_first_1_0(b, l + 1);
    return true;
  }

  // &DO post_expr_blocks
  private static boolean command_param_first_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "command_param_first_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = command_param_first_1_0_0(b, l + 1);
    r = r && post_expr_blocks(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // &DO
  private static boolean command_param_first_1_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "command_param_first_1_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = consumeToken(b, DO);
    exit_section_(b, l, m, r, false, null);
  ...
  static boolean decl_colon_equals(PsiBuilder b, int l) {
  ...
  public static boolean dot_suffix(PsiBuilder b, int l) {
    ...
    r = optind(b, l + 1);
    p = r; // pin = 1
    r = r && report_error_(b, ident_or_keyword(b, l + 1));
    r = p && dot_suffix_2(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  //                             (&NOSPACE LPAREN expr_colon_eq_expr RPAREN)?
  //                           )?
  private static boolean dot_suffix_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dot_suffix_2")) return false;
    dot_suffix_2_0(b, l + 1);
    return true;
  }

  // &NOSPACE LBRACKET_COLON expr_list RBRACKET
  //                             (&NOSPACE LPAREN expr_colon_eq_expr RPAREN)?
  private static boolean dot_suffix_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dot_suffix_2_0")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = dot_suffix_2_0_0(b, l + 1);
    r = r && consumeToken(b, LBRACKET_COLON);
    p = r; // pin = 2
    r = r && report_error_(b, expr_list(b, l + 1));
    r = p && report_error_(b, consumeToken(b, RBRACKET)) && r;
    r = p && dot_suffix_2_0_4(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // &NOSPACE
  private static boolean dot_suffix_2_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dot_suffix_2_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = noSpace(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // (&NOSPACE LPAREN expr_colon_eq_expr RPAREN)?
  private static boolean dot_suffix_2_0_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dot_suffix_2_0_4")) return false;
    dot_suffix_2_0_4_0(b, l + 1);
    return true;
  }

  // &NOSPACE LPAREN expr_colon_eq_expr RPAREN
  private static boolean dot_suffix_2_0_4_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dot_suffix_2_0_4_0")) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = dot_suffix_2_0_4_0_0(b, l + 1);
  ...
  // &NOSPACE
  private static boolean dot_suffix_2_0_4_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dot_suffix_2_0_4_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = noSpace(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  //                                )?
  static boolean expr_colon_eq_expr(PsiBuilder b, int l) {
  ...
  static boolean expr_colon_eq_expr_list(PsiBuilder b, int l) {
  ...
  static boolean expr_eq_expr(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // SYMBOL | ACCENT | OPR | NOT | NIL | CAST | IF | FOR | PROC | FUNC | ITERATOR
  //                         | BIND | LPAREN | LBRACKET | LBRACE | VAR | REF | PTR | ENUM | TUPLE | OBJECT
  //                         | WHEN | CASE | OUT | TRY | BLOCK
  //                         | literal
  //                         | built_in_magics
  static boolean expr_start(PsiBuilder b, int l) {
  ...
  public static boolean expr_stmt(PsiBuilder b, int l) {
    ...
    r = pmTrySimple(b, l + 1, simple_expr_parser_);
  ...
  static boolean extra_post_expr_block(PsiBuilder b, int l) {
  ...
  public static boolean ident(PsiBuilder b, int l) {
    ...
    r = consumeToken(b, SYMBOL);
    if (!r) r = built_in(b, l + 1);
    if (!r) r = built_in_magics(b, l + 1);
    if (!r) r = c_type(b, l + 1);
    if (!r) r = ident_4(b, l + 1);
    if (!r) r = ident_5(b, l + 1);
    if (!r) r = acc_quoted(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // <<inSymbolModeAfterDot>> keyword
  private static boolean ident_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ident_4")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = inSymbolModeAfterDot(b, l + 1);
    r = r && keyword(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // <<inSymbolModeAllowNil>> nil_lit
  private static boolean ident_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ident_5")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = inSymbolModeAllowNil(b, l + 1);
    r = r && nil_lit(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  static boolean ident_colon_equals_0(PsiBuilder b, int l, Parser _p) {
  ...
  static boolean ident_colon_equals_1(PsiBuilder b, int l, Parser _p) {
  ...
  /* ********************************************************** */
  // <<ident_colon_equals_1 ident_dot_with_pragma>>
  //                           post_expr_blocks? ind_and_comment
  public static boolean ident_defs(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ident_defs")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, IDENT_DEFS, "<ident defs>");
    r = ident_colon_equals_1(b, l + 1, NimParser::ident_dot_with_pragma);
    r = r && ident_defs_1(b, l + 1);
  ...
  // post_expr_blocks?
  private static boolean ident_defs_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ident_defs_1")) return false;
    post_expr_blocks(b, l + 1);
    return true;
  }
  ...
  static boolean ident_dot_with_pragma(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // ident | keyword
  static boolean ident_or_keyword(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "ident_or_keyword")) return false;
    boolean r;
    r = ident(b, l + 1);
  ...
  //                         | cast_expr
  static boolean ident_or_literal(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // ident OPR?
  static boolean ident_vis(PsiBuilder b, int l) {
  ...
  static boolean ident_vis_dot(PsiBuilder b, int l) {
  ...
  /* ********************************************************** */
  // ident_vis pragma?
  static boolean ident_with_pragma(PsiBuilder b, int l) {
  ...
  static boolean ind_and_comment(PsiBuilder b, int l) {
  ...
  static boolean invalid(PsiBuilder b, int l) {
    return consumeToken(b, INVALID_SYMBOL);
  }
  ...
  /* ********************************************************** */
  // NIL
  public static boolean nil_lit(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "nil_lit")) return false;
    if (!nextTokenIs(b, NIL)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, NIL);
    exit_section_(b, m, NIL_LIT, r);
    return r;
  }

  /* ********************************************************** */
  // !<<eof>> <<initContext>> top_stmt_list
  static boolean nim_file(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "nim_file")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = nim_file_0(b, l + 1);
    r = r && initContext(b, l + 1);
    r = r && top_stmt_list(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // !<<eof>>
  private static boolean nim_file_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "nim_file_0")) return false;
    boolean r;
  ...
  private static boolean param_list_2_1(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = param_list_2_1_0(b, l + 1);
    r = r && param_list_2_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  static boolean param_list_colon(PsiBuilder b, int l) {
  ...
  //                         | !<<inPrimaryModeTrySimple>> LPAREN command_expr RPAREN
  ...
  static boolean post_expr_blocks(PsiBuilder b, int l) {
  ...
  // &INDNONE
  private static boolean primary_suffix_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "primary_suffix_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  //                           | cmd_start command_expr
  //                           )
  private static boolean primary_suffix_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "primary_suffix_5")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = primary_suffix_5_0(b, l + 1);
    r = r && primary_suffix_5_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // &INDNONE
  private static boolean primary_suffix_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "primary_suffix_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // <<inPrimaryModeTrySimple>> cmd_start
  //                           | cmd_start command_expr
  private static boolean primary_suffix_5_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "primary_suffix_5_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = primary_suffix_5_1_0(b, l + 1);
    if (!r) r = primary_suffix_5_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // <<inPrimaryModeTrySimple>> cmd_start
  private static boolean primary_suffix_5_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "primary_suffix_5_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = inPrimaryModeTrySimple(b, l + 1);
    r = r && cmd_start(b, l + 1);
  ...
  // cmd_start command_expr
  private static boolean primary_suffix_5_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "primary_suffix_5_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = cmd_start(b, l + 1);
  ...
  private static boolean raw_type_desc_1_0(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeTokens(b, 1, NOT, PRIMARY);
    p = r; // pin = 1
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  public static boolean routine_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, ROUTINE_EXPR, "<routine expr>");
  ...
  /* ********************************************************** */
  // (if_expr | when_expr | stmt) SEMICOLON?
  ...
  public static boolean semi_stmt_list(PsiBuilder b, int l) {
    ...
    r = r && semi_stmt_list_1(b, l + 1);
    r = r && optlist(b, l + 1, NimParser::semi_stmt_list_2_0, SEMICOLON_parser_);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  // SEMICOLON?
  private static boolean semi_stmt_list_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "semi_stmt_list_1")) return false;
    consumeToken(b, SEMICOLON);
    return true;
  }

  // INDGTEOPT stmt
  private static boolean semi_stmt_list_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "semi_stmt_list_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = optGTEIndent(b, l + 1);
    r = r && stmt(b, l + 1);
  ...
  /* ********************************************************** */
  // (<<sigilOpr>> optind)? ident_or_literal primary_suffix*
  static boolean simple_primary(PsiBuilder b, int l) {
  ...
  //                           | expr_stmt
  //                           ) COMMENT?
  static boolean simple_stmt(PsiBuilder b, int l) {
  ...
  // LET | USING
  private static boolean stmt_20_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "stmt_20_0")) return false;
    boolean r;
  ...
  public static boolean stmt_list(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, STMT_LIST, "<stmt list>");
    r = stmt_list_0(b, l + 1);
  ...
  private static boolean stmt_list_0(PsiBuilder b, int l) {
    ...
    r = r && indented(b, l + 1, stmt_list_0_1_0_parser_);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // SEMICOLON | INDEQ
  private static boolean stmt_list_0_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "stmt_list_0_1_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, SEMICOLON);
  ...
  /* ********************************************************** */
  // INDZERO (stmt | SEMICOLON &(INDNONE | INDZERO))*
  public static boolean top_stmt_list(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_stmt_list")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, STMT_LIST, "<top stmt list>");
    r = indZero(b, l + 1);
    r = r && top_stmt_list_1(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // (stmt | SEMICOLON &(INDNONE | INDZERO))*
  private static boolean top_stmt_list_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_stmt_list_1")) return false;
    while (true) {
      int c = current_position_(b);
      if (!top_stmt_list_1_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "top_stmt_list_1", c)) break;
    }
    return true;
  }

  // stmt | SEMICOLON &(INDNONE | INDZERO)
  private static boolean top_stmt_list_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_stmt_list_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = stmt(b, l + 1);
    if (!r) r = top_stmt_list_1_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // SEMICOLON &(INDNONE | INDZERO)
  private static boolean top_stmt_list_1_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_stmt_list_1_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, SEMICOLON);
    r = r && top_stmt_list_1_0_1_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // &(INDNONE | INDZERO)
  private static boolean top_stmt_list_1_0_1_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_stmt_list_1_0_1_1")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = top_stmt_list_1_0_1_1_0(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // INDNONE | INDZERO
  private static boolean top_stmt_list_1_0_1_1_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "top_stmt_list_1_0_1_1_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = indNone(b, l + 1);
    if (!r) r = indZero(b, l + 1);
  ...
  public static boolean try_expr(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, TRY_EXPR, null);
  ...
  private static boolean type_def_value_1_0(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, NOT, PRIMARY);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // var_tuple_lhs EQUALS optind expr
  //                           post_expr_blocks? ind_and_comment
  public static boolean var_tuple(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b);
    r = var_tuple_lhs(b, l + 1);
    r = r && consumeToken(b, EQUALS);
    r = r && optind(b, l + 1);
    r = r && expr(b, l + 1);
    r = r && var_tuple_4(b, l + 1);
    r = r && ind_and_comment(b, l + 1);
    exit_section_(b, m, VAR_TUPLE, r);
    return r;
  }

  // post_expr_blocks?
  private static boolean var_tuple_4(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_4")) return false;
    post_expr_blocks(b, l + 1);
    return true;
  }
  ...
  //                           optpar RPAREN
  //                           (COLON optind type_desc)?
  static boolean var_tuple_lhs(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_lhs")) return false;
    if (!nextTokenIs(b, LPAREN)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_);
    r = consumeToken(b, LPAREN);
    p = r; // pin = 1
    r = r && report_error_(b, optind(b, l + 1));
    r = p && report_error_(b, list(b, l + 1, NimParser::var_tuple_lhs_2_0, COMMA_parser_)) && r;
    r = p && report_error_(b, optpar(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, RPAREN)) && r;
    r = p && var_tuple_lhs_5(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }

  // (var_tuple_lhs | ident_with_pragma) COMMENT?
  private static boolean var_tuple_lhs_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_lhs_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = var_tuple_lhs_2_0_0(b, l + 1);
    r = r && var_tuple_lhs_2_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // var_tuple_lhs | ident_with_pragma
  private static boolean var_tuple_lhs_2_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_lhs_2_0_0")) return false;
    boolean r;
    r = var_tuple_lhs(b, l + 1);
    if (!r) r = ident_with_pragma(b, l + 1);
    return r;
  ...
  // COMMENT?
  private static boolean var_tuple_lhs_2_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_lhs_2_0_1")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // (COLON optind type_desc)?
  private static boolean var_tuple_lhs_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_lhs_5")) return false;
    var_tuple_lhs_5_0(b, l + 1);
    return true;
  }

  // COLON optind type_desc
  private static boolean var_tuple_lhs_5_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "var_tuple_lhs_5_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, COLON);
    r = r && optind(b, l + 1);
  ...
  public static boolean when_expr(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, WHEN)) return false;
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, WHEN_EXPR, null);
    r = consumeToken(b, WHEN);
    p = r; // pin = 1
    r = r && cond_expr(b, l + 1);
    exit_section_(b, l, m, r, p, null);
  ...
  /* ********************************************************** */
  // Expression root: basic_expr
  // Operator priority table:
  // 0: BINARY(simple_expr)
  // 1: BINARY(arrow_expr)
  // 2: BINARY(assign_expr)
  // 3: BINARY(or_expr)
  // 4: BINARY(and_expr)
  // 5: BINARY(cmp_expr)
  // 6: BINARY(slice_expr)
  ...
  // 8: BINARY(plus_expr)
  // 9: BINARY(mul_expr)
  // 10: BINARY(dollar_expr)
  // 11: ATOM(primary_expr)
  public static boolean basic_expr(PsiBuilder b, int l, int g) {
    if (!recursion_guard_(b, l, "basic_expr")) return false;
    addVariant(b, "<basic expr>");
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, "<basic expr>");
    r = primary_expr(b, l + 1);
    p = r;
    r = r && basic_expr_0(b, l + 1, g);
    exit_section_(b, l, m, null, r, p, null);
    return r || p;
  }

  public static boolean basic_expr_0(PsiBuilder b, int l, int g) {
    if (!recursion_guard_(b, l, "basic_expr_0")) return false;
    boolean r = true;
    while (true) {
      Marker m = enter_section_(b, l, _LEFT_, null);
      if (g < 0 && simple_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 0);
        exit_section_(b, l, m, SIMPLE_EXPR, r, true, null);
      }
      else if (g < 1 && arrow_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 1);
        exit_section_(b, l, m, ARROW_EXPR, r, true, null);
      }
      else if (g < 2 && assign_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 2);
        exit_section_(b, l, m, ASSIGN_EXPR, r, true, null);
      }
      else if (g < 3 && or_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 3);
        exit_section_(b, l, m, OR_EXPR, r, true, null);
      }
      else if (g < 4 && and_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 4);
        exit_section_(b, l, m, AND_EXPR, r, true, null);
      }
      else if (g < 5 && cmp_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 5);
        exit_section_(b, l, m, CMP_EXPR, r, true, null);
      }
      else if (g < 6 && slice_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 6);
        exit_section_(b, l, m, SLICE_EXPR, r, true, null);
      }
      else if (g < 7 && amp_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 7);
        exit_section_(b, l, m, AMP_EXPR, r, true, null);
      }
      else if (g < 8 && plus_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 8);
        exit_section_(b, l, m, PLUS_EXPR, r, true, null);
      }
      else if (g < 9 && mul_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 9);
        exit_section_(b, l, m, MUL_EXPR, r, true, null);
      }
      else if (g < 10 && dollar_expr_0(b, l + 1)) {
        r = basic_expr(b, l, 10);
        exit_section_(b, l, m, DOLLAR_EXPR, r, true, null);
      }
      else {
  ...
  // COMMENT?
  private static boolean simple_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "simple_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE OP1 COMMENT? optpar
  private static boolean arrow_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrow_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = arrow_expr_0_0(b, l + 1);
    r = r && consumeTokenSmart(b, OP1);
    r = r && arrow_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean arrow_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrow_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // COMMENT?
  private static boolean arrow_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "arrow_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE OP2 COMMENT? optpar
  private static boolean assign_expr_0(PsiBuilder b, int l) {
    ...
    r = r && consumeTokenSmart(b, OP2);
    r = r && assign_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // COMMENT?
  private static boolean assign_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "assign_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE (OP3|OP3_KW) COMMENT? optpar
  private static boolean or_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "or_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = or_expr_0_0(b, l + 1);
    r = r && or_expr_0_1(b, l + 1);
    r = r && or_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean or_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "or_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // OP3|OP3_KW
  private static boolean or_expr_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "or_expr_0_1")) return false;
    boolean r;
    r = consumeTokenSmart(b, OP3);
    if (!r) r = OP3_KW(b, l + 1);
    return r;
  }

  // COMMENT?
  private static boolean or_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "or_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE (OP4|OP4_KW) COMMENT? optpar
  private static boolean and_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "and_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = and_expr_0_0(b, l + 1);
    r = r && and_expr_0_1(b, l + 1);
    r = r && and_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean and_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "and_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // OP4|OP4_KW
  private static boolean and_expr_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "and_expr_0_1")) return false;
    boolean r;
    r = consumeTokenSmart(b, OP4);
    if (!r) r = OP4_KW(b, l + 1);
    return r;
  }

  // COMMENT?
  private static boolean and_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "and_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE (OP5|OP5_KW) COMMENT? optpar
  private static boolean cmp_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = cmp_expr_0_0(b, l + 1);
    r = r && cmp_expr_0_1(b, l + 1);
    r = r && cmp_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean cmp_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // OP5|OP5_KW
  private static boolean cmp_expr_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_expr_0_1")) return false;
    boolean r;
    r = consumeTokenSmart(b, OP5);
    if (!r) r = OP5_KW(b, l + 1);
    return r;
  }

  // COMMENT?
  private static boolean cmp_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "cmp_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE OP6 COMMENT? optpar
  ...
  // COMMENT?
  private static boolean slice_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "slice_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE OP7 COMMENT? optpar
  private static boolean amp_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "amp_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = amp_expr_0_0(b, l + 1);
    r = r && consumeTokenSmart(b, OP7);
    r = r && amp_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean amp_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "amp_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // COMMENT?
  private static boolean amp_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "amp_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE OP8 COMMENT? optpar
  private static boolean plus_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "plus_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = plus_expr_0_0(b, l + 1);
    r = r && consumeTokenSmart(b, OP8);
    r = r && plus_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean plus_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "plus_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // COMMENT?
  private static boolean plus_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "plus_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE (OP9|OP9_KW) COMMENT? optpar
  private static boolean mul_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "mul_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = mul_expr_0_0(b, l + 1);
    r = r && mul_expr_0_1(b, l + 1);
    r = r && mul_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean mul_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "mul_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // OP9|OP9_KW
  private static boolean mul_expr_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "mul_expr_0_1")) return false;
    boolean r;
    r = consumeTokenSmart(b, OP9);
    if (!r) r = OP9_KW(b, l + 1);
    return r;
  }

  // COMMENT?
  private static boolean mul_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "mul_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }

  // &INDNONE OP10 COMMENT? optpar
  private static boolean dollar_expr_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dollar_expr_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = dollar_expr_0_0(b, l + 1);
    r = r && consumeTokenSmart(b, OP10);
    r = r && dollar_expr_0_2(b, l + 1);
    r = r && optpar(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  // &INDNONE
  private static boolean dollar_expr_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dollar_expr_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _AND_);
    r = indNone(b, l + 1);
    exit_section_(b, l, m, r, false, null);
  ...
  // COMMENT?
  private static boolean dollar_expr_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "dollar_expr_0_2")) return false;
    COMMENT(b, l + 1);
    return true;
  }
  ...
  static final Parser simple_expr_parser_ = (b, l) -> basic_expr(b, l + 1, -1);

  private static final Parser param_list_2_0_parser_ = ident_colon_equals_0_$(NimParser::ident_with_pragma);
  private static final Parser stmt_list_0_1_0_parser_ = list_$(NimParser::stmt, NimParser::stmt_list_0_1_0_1);
