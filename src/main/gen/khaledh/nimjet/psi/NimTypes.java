...
public interface NimTypes {
  ...
  IElementType INDOPT = new NimElementType("INDOPT");
  IElementType IND_AND_COMMENT = new NimElementType("IND_AND_COMMENT");
  IElementType INT_LIT = new NimElementType("INT_LIT");
  ...
  IElementType SIMPLE_OBJECT_PART = new NimElementType("SIMPLE_OBJECT_PART");
  ...
  IElementType ARROW = new NimTokenType("ARROW");
  IElementType AS = new NimTokenType("AS");
  IElementType ASM = new NimTokenType("ASM");
  IElementType BACKTICK = new NimTokenType("BACKTICK");
  ...
  IElementType DOTLIKEOP = new NimTokenType("DOTLIKEOP");
  ...
  IElementType VAR_TUPLE = new NimTokenType("var_tuple");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == SIMPLE_OBJECT_PART) {
        return new NimSimpleObjectPartImpl(node);
      }
