...
public class NimDotOrCmdStartImpl extends ASTWrapperPsiElement implements NimDotOrCmdStart {

  public NimDotOrCmdStartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NimVisitor visitor) {
    visitor.visitDotOrCmdStart(this);
  }
